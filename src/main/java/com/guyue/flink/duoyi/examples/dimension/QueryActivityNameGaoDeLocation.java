...
import com.guyue.flink.duoyi.examples.dimension.function.DataToActivityBeanGaoDeFunction;
 ...
 */
public class QueryActivityNameGaoDeLocation {
	...
	public static void main(String[] args) throws Exception {
		...
		SingleOutputStreamOperator<ActivityBean> activityMapStream = dataStreamSource.map(new DataToActivityBeanGaoDeFunction());

		activityMapStream.print();

		DYFlinkUtilV1.getEnv().execute("QueryActivityNameGaoDeLocation");
	}
}
