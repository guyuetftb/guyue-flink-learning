 ...
 */
public class UserDefinedKeyedStateConfigTTLTest {
	...
	public static void main(String[] args) throws Exception {
		...
		SingleOutputStreamOperator<Tuple2<String, Integer>> mapStateStream = tuple2KeyedStream
			.map(new RichMapFunction<Tuple2<String, Integer>, Tuple2<String, Integer>>() {
				...
				public void open(Configuration configuration) throws Exception {
					...
					descriptor.enableTimeToLive(valueStateTtl);
		...
		DYFlinkUtilV1.getEnv().execute("UserDefinedKeyedStateConfigTTLTest");
	}
}
