...
import com.guyue.flink.duoyi.examples.source.function.MyParallelFileSourceFunction;
 ...
 */
public class UserDefindParallelFileSourceTest {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStreamSource<Tuple2<String, String>> userDefindStream = env
			.addSource(new MyParallelFileSourceFunction(path));
