 ...
 */
public class KafkaSourceKeyByTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// method 1
		SingleOutputStreamOperator<Tuple2<String, Integer>> flatMapWordFreq = lines.flatMap(new RichFlatMapFunction<String, Tuple2<String, Integer>>() {
			...
			public void flatMap(String s, Collector<Tuple2<String, Integer>> collector) throws Exception {
				...
				for (String word : words) {
					...
					collector.collect(Tuple2.of("FlatMap - " + word.toLowerCase(), 1));
				}
			}
