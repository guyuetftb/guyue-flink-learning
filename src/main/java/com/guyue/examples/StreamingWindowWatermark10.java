 ...
 * 2019/3/12
 */
public class StreamingWindowWatermark10 {

    private static final Logger log = LoggerFactory.getLogger(StreamingWindowWatermark10.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Long>> waterMarkStream = inputMap.assignTimestampsAndWatermarks(
            ...
            public long extractTimestamp(Tuple2<String, Long> element,
                ...
                log.info(" extractTimestamp ------------->"
                                 + ",currentThreadId:" + id + ",key:"
                                 + element.f0 + ",eventtime:[" + element.f1 + "|"
                                 + sdf.format(element.f1) + "],"
